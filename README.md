...
如果你只是想尽快找到合适入口，可以先按用途筛选，再看状态和检测时间。
...
首页精选榜单保留自动检测状态和检测时间，方便判断入口最近是否响应。结构化体验评分仍保存在 [`resources/resources.json`](resources/resources.json)，不再放入 README 表格展示。
...
| 持续验证 | 公开评分 | 风险透明 | 社区共建 |
| :---: | :---: | :---: | :---: |
| 每条资源展示最后验证日期 | 结构化记录体验评分 | 版权、安全、隐私与支付风险单独标记 | 通过 Issue 和 PR 推荐、纠错与更新 |
